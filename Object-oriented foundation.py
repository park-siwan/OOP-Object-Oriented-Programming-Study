class User:
    ...
    def num_following(self):
        number = len(self.following_list)
        return number

    # 나를 몇 명이 팔로우하는지 리턴
    def num_followers(self):
        number = len(self.followers_list)
        return number


# 유저들 생성
user1 = User("siwan", "pswan3168@gmail.com", "123456")
user2 = User("minsoo", "minsoo@gmail.com", "abcdef")
user3 = User("soohyun", "soohyun@gmail.com", "123abc")
user4 = User("junghun", "junghun@gmail.com", "abc123")
